...
?>
<form action="index.php?option=com_talent&view=agents" method="post"
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				...
				foreach ( $this->items as $i => $row ) :
					$link = JRoute::_ ( 'index.php?option=com_talent&task=agent.edit&id=' . $row->id );
					?>
					<tr>
				...
				<td align="center">
							<?php echo JHtml::_('jgrid.published', $row->published, $i, 'agents.', true, 'cb'); ?>
						</td>
				<td align="center">
							<?php echo $row->id; ?>
						</td>
