...
class ActivityModelType extends JModelAdmin 
{
	...
	public $typeAlias = 'com_activity.type';
	protected  $canDo;
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_activity.type', 'type', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	{
		return 'administrator/components/com_activity/models/forms/type.js';
	}
