...
class ActivityModelActivity extends JModelAdmin 
{
	...
	public $typeAlias = 'com_activity.activity';
	...
	public function getItem($pk = null)
	{
		if ($item = parent::getItem($pk))
		{
			...
			$query->select($db->quoteName(array('activity_type_id')));
	...
	{
		// Get the form.
		$form = $this->loadForm('com_activity.activity', 'activity', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	{
		return 'administrator/components/com_activity/models/forms/activity.js';
	}

	public function getCss()
	{
		return 'administrator/components/com_activity/models/forms/activity.css';
	}
