...
?>
<form
	action="<?php echo JRoute::_('index.php?option=com_activity&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>
		...
		<div class="row-fluid form-horizontal-desktop">
			<div class="span9">
				...
				<fieldset class="adminform">
					<?php echo $this->form->getInput('activitytext'); ?>
				</fieldset>
			</div>
			<div class="span3">
		...
		<div class="row-fluid form-horizontal-desktop">
			<?php echo $this->form->getInput('activityimages'); ?>
		</div>
		<?php echo JHtml::_('bootstrap.endTab'); ?>
		
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'talents', JText::_('Talents', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<?php echo $this->form->getInput('activitytalents'); ?>
		</div>
		<?php echo JHtml::_('bootstrap.endTab'); ?>
