...
class ActivityViewTalents extends JViewLegacy 
{
	protected $canDo;
	...
	function display($tpl = null) 
	{
		...
		$context = "activity.list.admin.talents";
		...
		// Set the submenu
		ActivityHelper::addSubmenu ( 'talents' );
	...
	{
		$title = JText::_ ( 'COM_ACTIVITY_MANAGER_TALENTS' );
