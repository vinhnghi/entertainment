...
class ActivityControllerActivity extends JControllerForm
{
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if (ActivityHelper::getActions ( $recordId, 'activity' )->get ( 'core.edit' ))
		{
			return true;
		}
		...
		if (ActivityHelper::getActions ( $recordId, 'activity' )->get ( 'core.edit.own' ))
		{
